...
const GraphSection = () => {
    return (
        <section className="bg-white py-16 md:py-24">
            <Container>
                <div className="relative py-16 md:py-18">
                    {/* Purple background layer — overflow-hidden keeps decorations clipped */}
                    <div className="absolute inset-0 bg-[#4F46E5] overflow-hidden border border-slate-200">
                        {/* Top-left corner cut */}
                        <div className="absolute  w-14 h-14 md:w-24 md:h-24 bg-white clip-top-left" />
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center text-white">
                        ...
                        <div className="flex-1 relative mt-10 md:mt-0 w-full">
                            ...
                            <div className="relative w-full h-98 hidden md:block md:translate-x-3 md:translate-y-5">
                                <Image
