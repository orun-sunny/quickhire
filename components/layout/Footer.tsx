                    ...
                    <div>
                        ...
                        <form className="flex flex-col sm:flex-row gap-3">
                            <input
                                ...
                                className="w-full bg-white px-4 py-3 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                            />
                    ...
                    <div className="flex gap-4">
                        {[
                            ...
                            <a
                                key={i.name}
                                href="#"
                                className="h-8 w-8 rounded-full bg-slate-700 flex items-center justify-center hover:bg-slate-600 transition-all duration-200"
                            >
                                <Image src={i.src} alt={i.name} width={12} height={12} />
                            </a>
                        ))}
                    </div>
                </div>
